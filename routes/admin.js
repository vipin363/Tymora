...
router.post('/otp', forgotOtpLimiter, verifyAdminForgotOtp);
router.post('/resend-otp', forgotResendLimiter, resendAdminOtp);
...
router.post(
  '/categoryManagement/add',
  isAdminAuth,
  upload.single('image'),
  addCategory
);
router.post(
  '/categoryManagement/edit/:id',
  isAdminAuth,
  upload.single('image'),
  editCategory
);
...
router.post(
  '/categoryManagement/permanent-delete/:id',
  isAdminAuth,
  permanentDeleteCategory
);
...
router.post(
  '/products/variants/:variantId/edit',
  isAdminAuth,
  uploadProduct.array('images', 10),
  editVariant
);
...
router.post(
  '/products/variants/:variantId/restore',
  isAdminAuth,
  restoreVariant
);
router.post(
  '/products/variants/:variantId/permanent-delete',
  isAdminAuth,
  permanentDeleteVariant
);
...
router.post(
  '/products/:productId/variants/:variantId/set-default',
  isAdminAuth,
  setDefaultVariant
);
router.post(
...
router.post(
  '/orders/:orderId/items/:itemId/return-action',
  isAdminAuth,
  updateItemReturnAction
);
...
router.get('/ledger', isAdminAuth, (req, res) =>
